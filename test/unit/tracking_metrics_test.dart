  ...
  group('TrackingMetrics Model Tests', () {
    ...
    group('formattedPace', () {
      ...
      test('should return --:-- for 0 or negative pace', () {
        expect(
          const TrackingMetrics(currentPaceMinPerKm: 0).formattedPace,
          '--:--',
        );
        expect(
          const TrackingMetrics(currentPaceMinPerKm: -1).formattedPace,
          '--:--',
        );
      });
      ...
      test('should return --:-- for infinite pace', () {
        expect(
          const TrackingMetrics(
            currentPaceMinPerKm: double.infinity,
          ).formattedPace,
          '--:--',
        );
      });
